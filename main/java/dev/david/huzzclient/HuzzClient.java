...
import dev.david.huzzclient.feature.AnchorMacroController;
import dev.david.huzzclient.feature.AreaMinerController;
import dev.david.huzzclient.feature.AutoEatController;
import dev.david.huzzclient.feature.AutoMineController;
...
import dev.david.huzzclient.feature.CriticalsController;
...
import dev.david.huzzclient.feature.PlayerChunkLoadTracker;
...
import dev.david.huzzclient.feature.SusTracker;
import dev.david.huzzclient.feature.TimeChangerController;
import dev.david.huzzclient.feature.TunnelBaseFinderController;
import dev.david.huzzclient.feature.AutoWalkController;
import dev.david.huzzclient.feature.LsdController;
...
public final class HuzzClient implements ClientModInitializer {
    ...
    private static final SusTracker SUS_TRACKER = new SusTracker(CONFIG_MANAGER);
    ...
    private static final CriticalsController CRITICALS_CONTROLLER = new CriticalsController(CONFIG_MANAGER);
    private static final AnchorMacroController ANCHOR_MACRO_CONTROLLER = new AnchorMacroController(CONFIG_MANAGER);
    ...
    private static final TunnelBaseFinderController TUNNEL_BASE_FINDER_CONTROLLER = new TunnelBaseFinderController(CONFIG_MANAGER);
    private static final AutoEatController AUTO_EAT_CONTROLLER = new AutoEatController(CONFIG_MANAGER);
    private static final AutoMineController AUTO_MINE_CONTROLLER = new AutoMineController(CONFIG_MANAGER);
    private static final AutoWalkController AUTO_WALK_CONTROLLER = new AutoWalkController(CONFIG_MANAGER);
    private static final AreaMinerController AREA_MINER_CONTROLLER = new AreaMinerController(CONFIG_MANAGER);
    private static final PlayerChunkLoadTracker PLAYER_CHUNK_LOAD_TRACKER = new PlayerChunkLoadTracker(CONFIG_MANAGER);
    private static final LsdController LSD_CONTROLLER = new LsdController(CONFIG_MANAGER);
    private static final MusicHudController MUSIC_HUD_CONTROLLER = new MusicHudController(CONFIG_MANAGER);
    ...
    public void onInitializeClient() {
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            ANCHOR_MACRO_CONTROLLER.tick(client);
            ...
            TUNNEL_BASE_FINDER_CONTROLLER.tick(client);
            AUTO_EAT_CONTROLLER.tick(client);
            AUTO_MINE_CONTROLLER.tick(client);
            AUTO_WALK_CONTROLLER.tick(client);
            AREA_MINER_CONTROLLER.tick(client);
            PLAYER_CHUNK_LOAD_TRACKER.tick(client);
            LSD_CONTROLLER.tick(client);
            MUSIC_HUD_CONTROLLER.tick(client);
    ...
    public static SusTracker getSusTracker() {
        return SUS_TRACKER;
    }
    ...
    public static CriticalsController getCriticalsController() {
        return CRITICALS_CONTROLLER;
    }

    public static AnchorMacroController getAnchorMacroController() {
        return ANCHOR_MACRO_CONTROLLER;
    }
    ...
    public static TunnelBaseFinderController getTunnelBaseFinderController() {
        return TUNNEL_BASE_FINDER_CONTROLLER;
    }

    public static AutoEatController getAutoEatController() {
        return AUTO_EAT_CONTROLLER;
    }

    public static AutoMineController getAutoMineController() {
        return AUTO_MINE_CONTROLLER;
    }

    public static AutoWalkController getAutoWalkController() {
        return AUTO_WALK_CONTROLLER;
    }

    public static LsdController getLsdController() {
        return LSD_CONTROLLER;
    }

    public static MusicHudController getMusicHudController() {
        return MUSIC_HUD_CONTROLLER;
    }

    public static PlayerChunkLoadTracker getPlayerChunkLoadTracker() {
        return PLAYER_CHUNK_LOAD_TRACKER;
    }
    ...
    public static void clearRuntimeState(MinecraftClient client) {
        ...
        ANCHOR_MACRO_CONTROLLER.clear();
        CRAFTER_MACRO_CONTROLLER.clear();
        FAKE_STATS_CONTROLLER.clear();
        DOUBLE_CLICK_CONTROLLER.clear();
        SILENT_SET_HOME_CONTROLLER.clear();
        TUNNEL_BASE_FINDER_CONTROLLER.clear();
        AUTO_EAT_CONTROLLER.clear();
        AUTO_MINE_CONTROLLER.clear();
        AUTO_WALK_CONTROLLER.clear();
        AREA_MINER_CONTROLLER.clear();
        PLAYER_CHUNK_LOAD_TRACKER.clear();
        LSD_CONTROLLER.clear();
        MUSIC_HUD_CONTROLLER.clear(client);
    }
    ...
    public static void handleChunkDeltaUpdate(ChunkDeltaUpdateS2CPacket packet) {
        ...
        SUS_TRACKER.recordChunkDelta(packet);
    }
    ...
    public static void handleChunkData(ChunkDataS2CPacket packet) {
        ...
        SUS_TRACKER.recordChunkData(client, packet);
        PLAYER_CHUNK_LOAD_TRACKER.recordChunkData(packet);
    }
    ...
    public static void handleBlockUpdate(BlockUpdateS2CPacket packet) {
        ...
        SUS_TRACKER.recordBlockUpdate(packet);
    }
    ...
    public static void handleEntityStatus(EntityStatusS2CPacket packet) {
        ...
        var entity = packet.getEntity(client.world);
        AUTO_CRYSTAL_CONTROLLER.recordTotemPop(client, entity);
        ANCHOR_MACRO_CONTROLLER.recordTotemPop(client, entity);
        AUTO_TOTEM_CONTROLLER.recordTotemPop(client, entity);
    }
