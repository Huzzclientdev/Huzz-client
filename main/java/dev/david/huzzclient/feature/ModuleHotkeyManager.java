...
public final class ModuleHotkeyManager {
    ...
    private void toggleModule(HuzzConfig config, HuzzConfig.ModuleKey moduleKey) {
        switch (moduleKey) {
            ...
            case SUS_CHUNK_FINDER -> config.setSusChunkFinderEnabled(!config.isSusChunkFinderEnabled());
            case SUS_ESP -> config.setSusEspEnabled(!config.isSusEspEnabled());
            ...
            case CRITICALS -> config.setCriticalsEnabled(!config.isCriticalsEnabled());
            case ANCHOR_MACRO -> config.setAnchorMacroEnabled(!config.isAnchorMacroEnabled());
            ...
            case MUSIC_HUD -> config.setHudMusicEnabled(!config.isHudMusicEnabled());
            ...
            case GOON -> config.setGoonEnabled(!config.isGoonEnabled());
            ...
            case AUTO_MINE -> config.setAutoMineEnabled(!config.isAutoMineEnabled());
            case AUTO_WALK -> config.setAutoWalkEnabled(!config.isAutoWalkEnabled());
            case AREA_MINER -> config.setAreaMinerEnabled(!config.isAreaMinerEnabled());
            case LSD -> config.setLsdEnabled(!config.isLsdEnabled());
        }
    }
