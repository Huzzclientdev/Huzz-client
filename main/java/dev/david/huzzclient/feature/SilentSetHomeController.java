...
public final class SilentSetHomeController {
    ...
    private static final long OVERLAY_SUPPRESSION_WINDOW_MS = 1500L;
    ...
    public boolean shouldSuppressOverlay() {
        ...
        return now <= suppressUntilMs && suppressUntilMs - now <= SUPPRESSION_WINDOW_MS && suppressUntilMs - now >= SUPPRESSION_WINDOW_MS - OVERLAY_SUPPRESSION_WINDOW_MS;
    }
