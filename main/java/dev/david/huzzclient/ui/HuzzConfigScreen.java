...
public final class HuzzConfigScreen extends Screen {
    ...
    private void addMusicHudWidgets(ColumnLayout columnLayout, int moduleTop) {
        ...
        addHudToggle(columnLayout, moduleTop, 1, workingCopy.isHudMusicLargeUi(), () -> workingCopy.setHudMusicLargeUi(!workingCopy.isHudMusicLargeUi()));
        ...
        addStepButtons(columnLayout, moduleTop, 3, "<", ">", true,
    ...
    private void drawModule(DrawContext context, ColumnLayout columnLayout, Module module, int top) {
        ...
        switch (module) {
            ...
            case MUSIC_HUD -> {
                ...
                drawOptionRow(context, columnLayout, top, 3, "Src", workingCopy.getMusicHudSource().label(), true);
            }
            case CRAFTER_MACRO -> {
    ...
    private int liveCount(Module module) {
        return switch (module) {
            ...
            case BREAK_PROGRESS, AIM_FOV, SWING_SPEED, FREE_CAM, FREE_LOOK, AUTO_REPLENISH, AUTO_BRIDGE, AIM_ASSIST, AUTO_TOOL, AUTO_CRYSTAL, FAST_USE,
                ...
                NAME_PROTECT, SKIN_PROTECT, AUTO_RECONNECT, FAKE_SPAWNER, FAKE_ELYTRA, BEDROCK_PROTECT, SILENT_SET_HOME, DOUBLE_CLICK, DUAL_ARM_ANIMATION, GOON, TUNNEL_BASE_FINDER, AUTO_EAT, AUTO_MINE, AUTO_WALK, HUD, MUSIC_HUD, NONE -> -1;
        };
    }
