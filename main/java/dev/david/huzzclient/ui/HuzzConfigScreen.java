...
public final class HuzzConfigScreen extends Screen {
    ...
    private void addModuleWidgets(ColumnLayout columnLayout, Module module, int moduleTop) {
        ...
        switch (module) {
            ...
            case PRIME_CHUNK_FINDER, PLAYER_NOTIFIER, PLAYER_ESP, AUTO_DISCONNECT, FAKE_MEDIA, FAKE_PAY, HUD, NONE -> {
            }
        }
    }
    ...
    private void drawModule(DrawContext context, ColumnLayout columnLayout, Module module, int top) {
        ...
        switch (module) {
            ...
            case AUTO_RECONNECT -> {
                drawOptionRow(context, columnLayout, top, 0, "IP", "donutsmp.net", workingCopy.isAutoReconnectEnabled());
    ...
    private void setModuleKeyCode(Module module, int keyCode) {
        switch (module) {
            ...
            case PRIME_CHUNK_FINDER, HOLE_ESP, STASH_FINDER, BLOCK_NOTIFIER, CHAT_MACRO, PLAYER_NOTIFIER, AUTO_DISCONNECT,
                PLAYER_ESP, SWING_SPEED, FAST_USE, FAKE_MEDIA, FAKE_PAY, FAKE_STATS, AUTO_TOTEM, AUTO_ROCKET, NAME_PROTECT,
                SKIN_PROTECT, AUTO_RECONNECT, HUD, CRAFTER_MACRO, NONE -> {
            }
        }
    }
    ...
    private int moduleKeyCode(Module module) {
        return switch (module) {
            ...
            case PRIME_CHUNK_FINDER, HOLE_ESP, STASH_FINDER, BLOCK_NOTIFIER, CHAT_MACRO, PLAYER_NOTIFIER, AUTO_DISCONNECT,
                PLAYER_ESP, SWING_SPEED, FAST_USE, FAKE_MEDIA, FAKE_PAY, FAKE_STATS, AUTO_TOTEM, AUTO_ROCKET, NAME_PROTECT,
                SKIN_PROTECT, AUTO_RECONNECT, HUD, CRAFTER_MACRO, NONE -> HuzzConfig.NO_KEY;
        };
    }
    ...
    private int optionCount(Module module) {
        return switch (module) {
            ...
            case HOLE_ESP, PLAYER_NOTIFIER, AUTO_DISCONNECT, PLAYER_ESP, SWING_SPEED, FAKE_MEDIA, FAKE_PAY, FAST_USE, AUTO_TOTEM, AUTO_ROCKET, NAME_PROTECT, SKIN_PROTECT, HUD -> 1;
            case STASH_FINDER -> 1;
    ...
    private int liveCount(Module module) {
        return switch (module) {
            ...
            case SWING_SPEED, FREE_CAM, FREE_LOOK, FAST_USE, STASH_FINDER, FULL_BRIGHT, ITEM_NAMETAGS, FAKE_MEDIA, FAKE_PAY, FAKE_STATS, AUTO_TOTEM, AUTO_ROCKET, NAME_PROTECT, SKIN_PROTECT, AUTO_RECONNECT, HUD, NONE -> -1;
        };
    }
