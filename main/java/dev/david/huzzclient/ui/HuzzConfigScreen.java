...
public final class HuzzConfigScreen extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawText(textRenderer, title, layout.left(), 6, HuzzUi.uiTextPrimary(), false);
        context.drawText(textRenderer, Text.literal("Right Ctrl to reopen"), layout.left() + 58, 6, HuzzUi.uiTextMuted(), false);
    ...
    private void drawColumnHeader(DrawContext context, Layout layout, ColumnLayout columnLayout, ColumnGroup group) {
        ...
        context.drawText(textRenderer, groupTitle, columnLayout.centerX() - textRenderer.getWidth(groupTitle) / 2, layout.top() + 5, HuzzUi.uiTextPrimary(), false);
    }
    ...
    private void drawModule(DrawContext context, ColumnLayout columnLayout, Module module, int top) {
        ...
        HuzzUi.drawPanel(
            ...
            HuzzUi.withAlpha(moduleBorderColor(module, accent), 210)
        );
    ...
    private int moduleBorderColor(Module module, int accent) {
        ...
        return blendColor(accent, HuzzUi.uiTextSecondary(), 0.42F);
    }
