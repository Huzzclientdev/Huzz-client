...
public final class HuzzConfigScreen extends Screen {
    ...
    private void addModuleWidgets(ColumnLayout columnLayout, Module module, int moduleTop) {
        ...
        switch (module) {
            ...
            case PLAYER_NOTIFIER, PLAYER_ESP, AUTO_DISCONNECT, FAKE_MEDIA, FAKE_PAY, SILENT_SET_HOME, DUAL_ARM_ANIMATION, NONE -> {
            }
    ...
    private int optionCount(Module module) {
        int baseRows = switch (module) {
            ...
            case HOLE_ESP, BREAK_PROGRESS, PLAYER_NOTIFIER, AUTO_DISCONNECT, PLAYER_ESP, AIM_FOV, SWING_SPEED, AUTO_REPLENISH,
                AUTO_BRIDGE, AUTO_TOOL, FAKE_MEDIA, FAKE_PAY, FAST_USE, AUTO_TOTEM, AUTO_ROCKET, NAME_PROTECT,
                SKIN_PROTECT, SILENT_SET_HOME, DUAL_ARM_ANIMATION -> 1;
            case AUTO_CRYSTAL -> 1;
            case AIM_ASSIST -> 4;
            case STASH_FINDER -> 1;
    ...
    private int liveCount(Module module) {
        return switch (module) {
            ...
            case BREAK_PROGRESS, AIM_FOV, SWING_SPEED, FREE_CAM, FREE_LOOK, AUTO_REPLENISH, AUTO_BRIDGE, AIM_ASSIST, AUTO_TOOL, AUTO_CRYSTAL, FAST_USE,
                STASH_FINDER, CUSTOM_FOV, FULL_BRIGHT, MOTION_BLUR, NO_RENDER, BLOCK_SELECT, ITEM_NAMETAGS, FAKE_MEDIA, FAKE_PAY, FAKE_STATS, AUTO_TOTEM, AUTO_ROCKET,
                NAME_PROTECT, SKIN_PROTECT, AUTO_RECONNECT, FAKE_SPAWNER, FAKE_ELYTRA, SILENT_SET_HOME, DOUBLE_CLICK, DUAL_ARM_ANIMATION, HUD, NONE -> -1;
        };
    }
