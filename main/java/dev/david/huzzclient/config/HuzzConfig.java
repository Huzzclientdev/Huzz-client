...
public final class HuzzConfig {
    ...
    public void setModuleKeyCode(ModuleKey moduleKey, int keyCode) {
        ...
        switch (moduleKey) {
            ...
            case PRIME_CHUNK_FINDER, PLAYER_CHUNKS, HOLE_ESP, BREAK_PROGRESS, STASH_FINDER, BLOCK_NOTIFIER, CHAT_MACRO,
                PLAYER_NOTIFIER, AUTO_DISCONNECT, PLAYER_ESP, SWING_SPEED, AUTO_REPLENISH, AUTO_BRIDGE, AUTO_TOOL, AUTO_CRYSTAL,
                AIM_ASSIST, AIM_FOV,
                FAST_USE, CUSTOM_FOV, MOTION_BLUR, NO_RENDER, BLOCK_SELECT, FAKE_MEDIA, FAKE_PAY, FAKE_STATS, AUTO_TOTEM,
                AUTO_ROCKET, NAME_PROTECT, SKIN_PROTECT, AUTO_RECONNECT, HUD, CRAFTER_MACRO -> {
            }
        }
    }
