...
public final class HuzzConfig {
    ...
    public static final int MIN_SUS_CHUNK_SENSITIVITY = 1;
    public static final int MAX_SUS_CHUNK_SENSITIVITY = 24;
    public static final int DEFAULT_SUS_CHUNK_SENSITIVITY = 6;
    public static final int MIN_AREA_MINER_SIZE = 1;
    public static final int MAX_AREA_MINER_SIZE = 80;
    public static final int DEFAULT_AREA_MINER_SIZE = 16;
    public static final int MIN_AREA_MINER_HEIGHT = 2;
    public static final int MAX_AREA_MINER_HEIGHT = 40;
    public static final int DEFAULT_AREA_MINER_HEIGHT = 4;
    ...
    private boolean susChunkFinderEnabled;
    private boolean susChunkFinderTracers = true;
    private boolean susEspEnabled;
    private boolean susEspTracers = true;
    ...
    private boolean autoCrystalStopOnTotemPop = true;
    private boolean criticalsEnabled;
    private boolean anchorMacroEnabled;
    ...
    private boolean hudMusicLyricsEnabled;
    ...
    private boolean areaMinerEnabled;
    ...
    private boolean aimAssistPlayersOnly;
    private boolean aimAssistPredictMovement;
    ...
    private int autoTotemSwitchSlot;
    ...
    private int susChunkSensitivity = DEFAULT_SUS_CHUNK_SENSITIVITY;
    private int areaMinerSize = DEFAULT_AREA_MINER_SIZE;
    private int areaMinerHeight = DEFAULT_AREA_MINER_HEIGHT;
    ...
    public boolean isSusChunkFinderEnabled() {
        return susChunkFinderEnabled;
    }

    public void setSusChunkFinderEnabled(boolean susChunkFinderEnabled) {
        this.susChunkFinderEnabled = susChunkFinderEnabled;
    }

    public boolean isSusChunkFinderTracers() {
        return susChunkFinderTracers;
    }

    public void setSusChunkFinderTracers(boolean susChunkFinderTracers) {
        this.susChunkFinderTracers = susChunkFinderTracers;
    }

    public boolean isSusEspEnabled() {
        return susEspEnabled;
    }

    public void setSusEspEnabled(boolean susEspEnabled) {
        this.susEspEnabled = susEspEnabled;
    }

    public boolean isSusEspTracers() {
        return susEspTracers;
    }

    public void setSusEspTracers(boolean susEspTracers) {
        this.susEspTracers = susEspTracers;
    }
    ...
    public boolean isAutoCrystalStopOnTotemPop() {
        return autoCrystalStopOnTotemPop;
    }

    public void setAutoCrystalStopOnTotemPop(boolean autoCrystalStopOnTotemPop) {
        this.autoCrystalStopOnTotemPop = autoCrystalStopOnTotemPop;
    }
    ...
    public boolean isAnchorMacroEnabled() {
        return anchorMacroEnabled;
    }

    public void setAnchorMacroEnabled(boolean anchorMacroEnabled) {
        this.anchorMacroEnabled = anchorMacroEnabled;
    }
    ...
    public boolean isHudMusicLyricsEnabled() {
        return hudMusicLyricsEnabled;
    }

    public void setHudMusicLyricsEnabled(boolean hudMusicLyricsEnabled) {
        this.hudMusicLyricsEnabled = hudMusicLyricsEnabled;
    }
    ...
    public int getAutoTotemSwitchSlot() {
        return clamp(autoTotemSwitchSlot, 0, 9);
    }

    public void setAutoTotemSwitchSlot(int autoTotemSwitchSlot) {
        this.autoTotemSwitchSlot = clamp(autoTotemSwitchSlot, 0, 9);
    }
    ...
    public boolean isAreaMinerEnabled() {
        return areaMinerEnabled;
    }

    public void setAreaMinerEnabled(boolean areaMinerEnabled) {
        this.areaMinerEnabled = areaMinerEnabled;
    }
    ...
    public boolean isAimAssistPlayersOnly() {
        return aimAssistPlayersOnly;
    }

    public void setAimAssistPlayersOnly(boolean aimAssistPlayersOnly) {
        this.aimAssistPlayersOnly = aimAssistPlayersOnly;
    }

    public boolean isAimAssistPredictMovement() {
        return aimAssistPredictMovement;
    }

    public void setAimAssistPredictMovement(boolean aimAssistPredictMovement) {
        this.aimAssistPredictMovement = aimAssistPredictMovement;
    }
    ...
    public int getSusChunkSensitivity() {
        return clamp(susChunkSensitivity, MIN_SUS_CHUNK_SENSITIVITY, MAX_SUS_CHUNK_SENSITIVITY);
    }

    public void setSusChunkSensitivity(int susChunkSensitivity) {
        this.susChunkSensitivity = clamp(susChunkSensitivity, MIN_SUS_CHUNK_SENSITIVITY, MAX_SUS_CHUNK_SENSITIVITY);
    }

    public int getAreaMinerSize() {
        return clamp(areaMinerSize, MIN_AREA_MINER_SIZE, MAX_AREA_MINER_SIZE);
    }

    public void setAreaMinerSize(int areaMinerSize) {
        this.areaMinerSize = clamp(areaMinerSize, MIN_AREA_MINER_SIZE, MAX_AREA_MINER_SIZE);
    }

    public int getAreaMinerHeight() {
        return evenAreaMinerHeight(areaMinerHeight);
    }

    public void setAreaMinerHeight(int areaMinerHeight) {
        this.areaMinerHeight = evenAreaMinerHeight(areaMinerHeight);
    }
    ...
    public void setModuleKeyCode(ModuleKey moduleKey, int keyCode) {
        ...
        switch (moduleKey) {
            ...
            case PRIME_CHUNK_FINDER, PLAYER_CHUNKS, HOLE_ESP, BEDROCK_HOLE_ESP, BREAK_PROGRESS, STASH_FINDER, BLOCK_NOTIFIER, SUS_CHUNK_FINDER, SUS_ESP, CHAT_MACRO,
                PLAYER_NOTIFIER, AUTO_DISCONNECT, PLAYER_ESP, MOB_ESP, SWING_SPEED, AUTO_REPLENISH, AUTO_BRIDGE, AUTO_TOOL, AUTO_CRYSTAL,
                CRITICALS, ANCHOR_MACRO, AIM_ASSIST, AIM_FOV,
                ...
                AUTO_MINE, AUTO_WALK, AREA_MINER, LSD -> {
            }
        }
    }
    ...
    public HuzzConfig copy() {
        ...
        copy.setSusChunkFinderEnabled(susChunkFinderEnabled);
        copy.setSusChunkFinderTracers(susChunkFinderTracers);
        copy.setSusEspEnabled(susEspEnabled);
        copy.setSusEspTracers(susEspTracers);
        ...
        copy.setAutoCrystalStopOnTotemPop(autoCrystalStopOnTotemPop);
        copy.setCriticalsEnabled(criticalsEnabled);
        copy.setAnchorMacroEnabled(anchorMacroEnabled);
        ...
        copy.setHudMusicLyricsEnabled(hudMusicLyricsEnabled);
        ...
        copy.setAutoTotemSwitchSlot(autoTotemSwitchSlot);
        ...
        copy.setAreaMinerEnabled(areaMinerEnabled);
        ...
        copy.setAimAssistPlayersOnly(aimAssistPlayersOnly);
        copy.setAimAssistPredictMovement(aimAssistPredictMovement);
        ...
        copy.setSusChunkSensitivity(susChunkSensitivity);
        copy.setAreaMinerSize(areaMinerSize);
        copy.setAreaMinerHeight(areaMinerHeight);
    ...
    public void copyFrom(HuzzConfig other) {
        ...
        setSusChunkFinderEnabled(other.isSusChunkFinderEnabled());
        setSusChunkFinderTracers(other.isSusChunkFinderTracers());
        setSusEspEnabled(other.isSusEspEnabled());
        setSusEspTracers(other.isSusEspTracers());
        ...
        setAutoCrystalStopOnTotemPop(other.isAutoCrystalStopOnTotemPop());
        setCriticalsEnabled(other.isCriticalsEnabled());
        setAnchorMacroEnabled(other.isAnchorMacroEnabled());
        ...
        setHudMusicLyricsEnabled(other.isHudMusicLyricsEnabled());
        ...
        setAutoTotemSwitchSlot(other.getAutoTotemSwitchSlot());
        ...
        setAreaMinerEnabled(other.isAreaMinerEnabled());
        ...
        setAimAssistPlayersOnly(other.isAimAssistPlayersOnly());
        setAimAssistPredictMovement(other.isAimAssistPredictMovement());
        ...
        setSusChunkSensitivity(other.getSusChunkSensitivity());
        setAreaMinerSize(other.getAreaMinerSize());
        setAreaMinerHeight(other.getAreaMinerHeight());
    ...
    public void disableAllModules() {
        ...
        setSusChunkFinderEnabled(false);
        setSusEspEnabled(false);
        ...
        setCriticalsEnabled(false);
        setAnchorMacroEnabled(false);
        ...
        setAreaMinerEnabled(false);
        setLsdEnabled(false);
        setAimAssistEnabled(false);
        setAimFovEnabled(false);
        setAimAssistVisibleOnly(false);
        setAimAssistPlayersOnly(false);
        setAimAssistPredictMovement(false);
    ...
    private static int evenAreaMinerHeight(int value) {
        int clamped = clamp(value, MIN_AREA_MINER_HEIGHT, MAX_AREA_MINER_HEIGHT);
        return clamped % 2 == 0 ? clamped : Math.min(MAX_AREA_MINER_HEIGHT, clamped + 1);
    }
