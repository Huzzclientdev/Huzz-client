...
public final class HuzzConfig {
    ...
    public static final int MAX_MOTION_BLUR_FRAMES = 24;
    ...
    public void setModuleKeyCode(ModuleKey moduleKey, int keyCode) {
        ...
        switch (moduleKey) {
            ...
            case PRIME_CHUNK_FINDER, HOLE_ESP, BREAK_PROGRESS, STASH_FINDER, BLOCK_NOTIFIER, CHAT_MACRO,
                PLAYER_NOTIFIER, AUTO_DISCONNECT, PLAYER_ESP, SWING_SPEED, AUTO_REPLENISH, AUTO_BRIDGE,
                FAST_USE, MOTION_BLUR, BLOCK_SELECT, FAKE_MEDIA, FAKE_PAY, FAKE_STATS, AUTO_TOTEM,
